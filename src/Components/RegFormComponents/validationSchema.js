  ...
  switch (step) {
    ...
    case 3:
      return Yup.object({
        ...
        has_tubercolosis: Yup.string().required("This field is required"),
        live_with_someone_with_tubercolosis: Yup.string().required("This field is required"),
        other_diagnosed_with_tubercolosis_beyond_4_months: Yup.string().required("This field is required"),
        
        has_blood_borne_disease: Yup.boolean().required("This field is required"),
        blood_borne_disease: Yup.string().required("This field is required"),
